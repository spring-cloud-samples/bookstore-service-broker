...
public class BookStoreSecurityIntegrationTests {
	...
	public void anonymousAccessIsUnauthorized() {
		assertExpectedResponseStatus(HttpStatus.UNAUTHORIZED, HttpStatus.UNAUTHORIZED, HttpStatus.UNAUTHORIZED,
	...
	public void fullAccessWithoutInstanceIdIsAllowed() {
		...
		assertExpectedResponseStatus(HttpStatus.OK, HttpStatus.OK, HttpStatus.CREATED, HttpStatus.OK);
	}
	...
	public void fullAccessWithOtherInstanceIdIsForbidden() {
		assertExpectedResponseStatus(HttpStatus.FORBIDDEN, HttpStatus.FORBIDDEN, HttpStatus.FORBIDDEN,
	...
	public void readOnlyWithoutInstanceIdIsPartiallyAllowed() {
		assertExpectedResponseStatus(HttpStatus.OK, HttpStatus.OK, HttpStatus.FORBIDDEN, HttpStatus.FORBIDDEN);
	}
